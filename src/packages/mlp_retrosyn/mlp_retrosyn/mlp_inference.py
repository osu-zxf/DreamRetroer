...
class MLPModel(object):
    ...
    def run(self, x, topk=10):
        ...
        top50_id_list = idx[0].numpy().tolist()
        reactants = []
        scores = []
        templates = []
        valid_rules_index = []
        for i , rule in enumerate(rule_k):
            ...
            try:
                ...
                valid_rules_index.append([i, probs[0][i].item()])
                out1 = sorted(out1)
            ...
            # out1 = rdchiralRunText(x, rule)
                ...
                pass
        valid_rule_id_list = [top50_id_list[index[0]] for index in valid_rules_index]
        valid_rule_prob_list = [index[1] for index in valid_rules_index]
        # print('top 50 valid:', valid_rule_id_list)
        # print('top 50 prob:', valid_rule_prob_list)
        # print(reactants)
