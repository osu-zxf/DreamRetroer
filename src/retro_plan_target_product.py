...
from dreamretroer.utils.prepare_methods import prepare_starting_molecules, prepare_mlp, prepare_graph_planner
...
def MCTS_Graph_plan():
    ...
    failed_id_list = [4]#, 7, 27, 38, 94, 140, 162, 177] # 162-len2
    failed_routes = [routes[failed_id] for failed_id in failed_id_list]
    ...
    plan_handle = prepare_graph_planner(
        one_step=one_step,
        value_fn=value_fn,
