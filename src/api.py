...
from dreamretroer.utils.prepare_methods import prepare_starting_molecules, prepare_mlp, \
    prepare_graph_planner
from dreamretroer.utils.smiles_process import smiles_to_fp, reaction_smarts_to_fp
from dreamretroer.model.eg_network import EG_MLP
from dreamretroer.utils.logger import setup_logger
import numpy as np
import os
...
class RSPlanner:
    def __init__(self,
                 ...
                 iterations=500,
                 use_value_fn=False,
                 starting_molecules=dirpath+'/dreamretroer/dataset/origin_dict.csv',
                 mlp_templates=dirpath+'/dreamretroer/one_step_model/template_rules_1.dat',
                 mlp_model_dump=dirpath+'/dreamretroer/one_step_model/retro_star_value_ours.ckpt',
                 save_folder=dirpath+'/dreamretroer/one_step_model',
                 value_model='best_egn_for_emol_2.pt',
                 viz=False,
                 viz_dir='viz'):
        ...
        self.plan_handle = prepare_graph_planner(
            one_step=one_step,
            value_fn=value_fn,
